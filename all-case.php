...
?>
  ...
  <head>
    ...
    <title>MedsCred | All Patients Case List</title>
              ...
              <form method="get">
                <div class="input-group">
                  ...
                  <div class="input-group-append">
                    ...
                    <a href="all-case.php" class="btn btn-lg btn-default">Reload</a>
                  </div>
                </div>
              </form>
            </div>
              ...
              <table class="table table-striped projects">
                ...
                <tbody>
                  ...
                  $sql = mysqli_query(
                    ...
                    WHERE 
                        p.is_active = 1 AND ss.is_active = '1' $searchCondition $filter"
                  );
                  $cnt = 1;
