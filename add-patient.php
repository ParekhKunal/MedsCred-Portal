...
?>
  ...
  <head>
    ...
    <title>MedsCred | Add Patient</title>
                  ...
                  <form method="post">
                    ...
                    <div class="form-group row">
                      <div class="col-md-12" style="margin-bottom: 20px;">
                        <span style="color: blue;">
                          You are initiating a patient lead from the Admin Portal<br>
                    ...
                    <div class="form-group row">
                      <div class="col-md-4">
                        ...
                        <input type="text" class="form-control" name="attendant_name" id="inputattendantname" placeholder="Attendant Name">
                      </div>
                      <div class="col-md-4">
                        <label for="inputEmail">Patient/Attendant Email<span style="color:red">*</span></label>
                        <input type="email" class="form-control" name="email" id="inputEmail" placeholder="Email">
                      </div>
                      <div class="col-md-4">
                        <label for="inputPhoneNumber">Patient/Attendant Phone Number<span style="color:red">*</span></label>
                        <input type="text" class="form-control" name="phone_number" id="inputPhoneNumber" placeholder="Phone Number">
                      </div>
                    </div>
                    <div class="form-group row">
                      <div class="col-md-6">
                        <label for="inputEmail">Alternate Email</label>
                        <input name="alternate_email" type="email" class="form-control" id="inputEmail" placeholder="Email">
                      </div>
                      <div class="col-md-6">
                        <label for="inputAlternatePhoneNumber">Alternate Phone Number</label>
                        <input type="text" name="alternate_phone_number" class="form-control" id="inputAlternatePhoneNumber" placeholder="Alternate Phone Number">
                      </div>
                    </div>
                    <div class="form-group row">
                      <div class="col-md-4">
                        ...
                        <div class="input-group date" id="reservationdate" data-target-input="nearest">
                          <input type="text" placeholder="<?php echo $today; ?>" class="form-control datetimepicker-input" data-target="#reservationdate" name="date_of_birth" value="<?php echo ($admin->date_of_birth) ?>" />
                      ...
                      <div class="col-md-4">
                        <label for="inputAadharCard">Aadhar Card<span style="color:red">*</span></label>
                        <input type="text" name="aadhar_card" class="form-control" id="inputAadharCard" placeholder="Phone Number">
                      </div>
                      <div class="col-md-4">
                        <label for="inputPanCard">PAN Card<span style="color:red">*</span></label>
                        <input type="text" name="pan_card" class="form-control" id="inputPanCard" placeholder="Phone Number">
                      </div>
                    </div>
                        ...
                        <div class="modal-dialog">
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <p>Are you sure you want to add patient?</p>
                            </div>
