...
?>
  ...
  <head>
    ...
    <title>MedsCred | Cashless Patients List</title>
              ...
              <form method="get">
                <div class="input-group">
                  ...
                  <div class="input-group-append">
                    ...
                    <a href="cashless.php" class="btn btn-lg btn-default">Reload</a>
                  </div>
                </div>
              </form>
            </div>
              ...
              <table class="table table-striped projects">
                ...
                <tbody>
                  ...
                  $sql = mysqli_query(
                    ...
                    WHERE 
                        p.is_active = 1 AND pci.loan_type=2 AND ss.is_active = '1' $searchCondition $filter"
                  );
                  $cnt = 1;
